 ...
 <div class="card-deck">
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a  href="{{route('checkoutkids',['id'=>$first_post->id])}}">
  ...
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a href="{{route('checkoutkids',['id'=>$second_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a  href="{{route('checkoutkids',['id'=>$third_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a href="{{route('checkoutkids',['id'=>$four_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a href="{{route('checkoutkids',['id'=>$five_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a href="{{route('checkoutkids',['id'=>$six_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
