 ...
 <div class="card-deck">
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a  href="{{route('checkoutwomen',['id'=>$first_post->id])}}">
  ...
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a href="{{route('checkoutwomen',['id'=>$second_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a  href="{{route('checkoutwomen',['id'=>$third_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">{{$four_post->name}}</h5>
      <p class="card-text">$Price{{$four_post->price}}</p>
    </div>
    <div class="card-footer text-center">
      <a href="{{route('checkoutwomen',['id'=>$four_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-footer text-center">
      <a href="{{route('checkoutwomen',['id'=>$five_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">{{$six_post->name}}</h5>
      <p class="card-text">Price${{$six_post->price}}</p>
    </div>
    <div class="card-footer text-center">
      <a href="{{route('checkoutwomen',['id'=>$six_post->id])}}">
      <button class="btn btn-success">Purchase</button>
    </a>
    </div>
  </div>
